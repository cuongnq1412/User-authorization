                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif ($group['check_approved'] == 1): ?>
                                                <i class="fa-solid fa-hourglass-start" style="color: #FFD43B;"></i>
                                            <?php elseif ($group['check_approved'] == 2): ?>
                                                <i class="fa-solid fa-circle-exclamation"
                                                    style="color: #ff2f0a;margin-right:10px;"></i>
                                                <a href="<?= BASE_PATH ?>/admin/profile/sendDistrict?id=<?= $group['id'] ?>"
                                                    style="margin-right:10px;">
                                                    <i class="fa-solid fa-paper-plane" style="color: #0dfd35;"></i>
                                                </a>
                                            <?php elseif ($group['check_approved'] == 3): ?>
                                                <i class="fa-solid fa-circle-check" style="color: #2bff00;"></i>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="#"
                                                onclick="confirmDelete('<?= BASE_PATH ?>/admin/profile/delete','<?php echo $group['id']; ?>')"><i
