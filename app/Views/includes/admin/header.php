<head>
    ...
    <script src="<?= BASE_PATH ?>/public/js/map.js" rel="stylesheet"></script>
    <link
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3"> Quản Lý Hội Nhóm </div>
            </a>
            ...
            <?php if ($_SESSION['customer']['level'] == 'commune') { ?>
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/group/add">Thêm Hội Nhóm</a>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/group/list">Danh Sách Hội Nhóm</a>
                    </div>
                </div>
            </li>
            <?php } ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTransaction" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/profile/add">Thêm Profile</a>
                    </div>
                </div>
            </li>
            <?php if ($_SESSION['customer']['level'] == 'district' || $_SESSION['customer']['level'] == 'admin') { ?>
            <li class="nav-item">
                ...
                <div id="collapseTransactions" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy Chọn :</h6>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/commune-review">Xét duyệt hội
                            nhóm</a>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/commune-review/list-accept">Danh
                            Sách đã duyệt</a>
                    </div>
                </div>
            </li>
            <?php } ?>
            <?php if ($_SESSION['customer']['level'] == 'city' || $_SESSION['customer']['level'] == 'admin') { ?>
            <li class="nav-item">
                ...
                <div id="collapseuser" class="collapse" aria-labelledby="headinguser" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy Chọn :</h6>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/district-review">Xét duyệt hội
                            nhóm</a>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/district-review/list-accept">Danh
                            Sách
                            hội nhóm toàn
                            tỉnh </a>
                    </div>
            ...
            <?php } ?>
            <?php if ($_SESSION['customer']['level'] == 'admin') { ?>
            <li class="nav-item">
                ...
                <div id="collapseusers" class="collapse" aria-labelledby="headinguser" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy Chọn:</h6>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/add-account">Thêm Tài Khoản</a>
                        <a class="collapse-item" href="<?php echo BASE_PATH ?>/admin/blog/add">Quản Lý Tài Khoản</a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    <?php if (isset($_SESSION['customer'])) { ?>
                                    <?php echo $_SESSION['customer']['name']; ?></span>
                                <?php } ?>
                                <img class="img-profile rounded-circle"
                                    src="https://e7.pngegg.com/pngimages/705/224/png-clipart-user-computer-icons-avatar-miscellaneous-heroes.png" />
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <?php if (isset($_SESSION['user'])) { ?>
                                <a class="dropdown-item" href="<?php echo BASE_PATH ?>/user/index">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Thông Tin
                                </a>
                                <?php } ?>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo BASE_PATH ?>/admin/logout">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Logout
                                </a>
                            </div>
